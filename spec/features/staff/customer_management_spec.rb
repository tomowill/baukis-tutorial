...
feature '職員による顧客管理' do
  ...
  scenario 'staff registers only customer basic information.' do
    click_link '顧客管理'
  ...
  scenario 'staff is customer, home address and business address are registerd' do
    click_link '顧客管理'
    first('div.links').click_link '新規登録'
  ...
  scenario 'staff is customer, home_address and business_address are updated' do
    click_link '顧客管理'
  ...
  scenario 'give company_name to existing customer who have no bussiness data.' do
  ...
  scenario 'staff sets invlid value to birthday and home_address_postal_code ' do
    click_link '顧客管理'
    first('table.listing').click_link '編集'
